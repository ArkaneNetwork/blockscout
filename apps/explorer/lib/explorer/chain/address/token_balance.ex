defmodule Explorer.Chain.Address.TokenBalance do
   ...
   *  `token_id` - The token_id of the transferred token (applicable for ERC-1155 tokens)
  """
  @type t :: %__MODULE__{
  ...
  def unfetched_token_balances do
    from(
      ...
      where:
        (tb.address_hash != ^@burn_address_hash and t.type != "ERC-721") or t.type == "ERC-20" or t.type == "ERC-1155"
    )
  end
end
